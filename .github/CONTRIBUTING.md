...
# Contributing to tweetr

This outlines how to propose a change to tweetr.
This guideline is adopted from the boiler plate template generated with the `usethis` package.
Our development team agree to this guideline as is.
...
-   Fork the package and clone onto your computer.
    If you haven't done this before, we recommend using `usethis::create_from_github("UBC-MDS/tweetr", fork = TRUE)`.
...
Please note that the tweetr project is released with a [Contributor Code of Conduct](CODE_OF_CONDUCT.md).
